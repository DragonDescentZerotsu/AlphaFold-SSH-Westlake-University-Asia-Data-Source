...
echo "    If you choose to use Asian mirror, please remove '--port=33444' from rsync command around line 51"
echo "    If you still face some problems, please Google 'ftp.pdbj.org' to look up instructions"
...
aria2c "https://ftp.pdbj.org/pub/pdb/data/status/obsolete.dat" --dir="${ROOT_DIR}"
# "https://ftp.wwpdb.org/pub/pdb/data/status/obsolete.dat"
